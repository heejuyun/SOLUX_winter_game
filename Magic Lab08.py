...
def selectScreen():
    global noonsong_y, cnt, hair, body, eyes, mouth, number1, number2, number3, number4
    select = True
    ...
    while select:
        ...
        button4 = Button1(buttonImg4, 442, 43, 100, 100, clickbuttonImg4, 442, 43, 4)
        button5 = Button2(buttonImg5, 548, 43, 100, 100, clickbuttonImg5, 548, 43, 1)
        button6 = Button2(buttonImg6, 654, 43, 100, 100, clickbuttonImg6, 654, 43, 2)
        button7 = Button3(buttonImg7, 82, 193, 100, 100, clickbuttonImg7, 82, 193, 1)
        button8 = Button3(buttonImg8, 188, 193, 100, 100, clickbuttonImg8, 188, 193, 2)
        button9 = Button4(buttonImg9, 548, 193, 100, 100, clickbuttonImg9, 548, 193, 1)
        button10 = Button4(buttonImg10, 654, 193, 100, 100, clickbuttonImg10, 654, 193, 2)
        button11 = Button4(buttonImg11, 82, 343, 100, 100, clickbuttonImg11, 82, 343, 3)
        button12 = Button4(buttonImg12, 188, 343, 100, 100, clickbuttonImg12, 188, 343, 4)
        button13 = Button4(buttonImg13, 294, 343, 100, 100, clickbuttonImg13, 294, 343, 5)
        button14 = Button4(buttonImg14, 442, 343, 100, 100, clickbuttonImg14, 442, 343, 6)
...
def resultScreen():
    ...
    while result:
        ...
        if(hair == 0 or body == 0 or eyes == 0 or mouth == 0):
            gamepad.blit(noonsong0Img, (330, 110)) # case 0
        elif (hair == 1 and body == 1 and eyes == 1 and mouth == 1):
