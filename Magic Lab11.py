...
def selectScreen():
    ...
    while select:
        ...
        button1 = Button1(buttonImg1, 35, 43, 100, 100, clickbuttonImg1, 35, 43, 1)
        button2 = Button1(buttonImg2, 95, 43, 100, 100, clickbuttonImg2, 95, 43, 2)
        button3 = Button1(buttonImg3, 155, 43, 100, 100, clickbuttonImg3, 155, 43, 3)

        button4 = Button2(buttonImg4, 550, 70, 100, 100, clickbuttonImg4, 550, 70, 1)
        button5 = Button2(buttonImg5, 620, 70, 100, 100, clickbuttonImg5, 620, 70, 2)

        button6 = Button3(buttonImg6, 55, 193, 100, 100, clickbuttonImg6, 55, 193, 1)
        button7 = Button3(buttonImg7, 135, 193, 100, 100, clickbuttonImg7, 135, 193, 2)

        button8 = Button4(buttonImg8, 540, 210, 100, 100, clickbuttonImg8, 540, 210, 1)
        button9 = Button4(buttonImg9, 630, 210, 100, 100, clickbuttonImg9, 630, 210, 2)
        button10 = Button4(buttonImg10, 550, 300, 100, 100, clickbuttonImg10, 550, 300, 3)
        button11 = Button4(buttonImg11, 630, 300, 100, 100, clickbuttonImg11, 630, 300, 4)

        button12 = Button5(buttonImg12, 35, 343, 100, 100, clickbuttonImg12, 35, 343, 1)
        button13 = Button5(buttonImg13, 105, 343, 100, 100, clickbuttonImg13, 105, 343, 2)
        button14 = Button5(buttonImg14, 195, 343, 100, 100, clickbuttonImg14, 195, 343, 3)
